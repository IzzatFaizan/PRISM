...
linear_svc_pipeline_ngram = Pipeline([
    ('svmCV', tfidf_vect_ngram),
...
req = linear_svc_pipeline_ngram.fit(train_x, train_y)
predicted_svm = linear_svc_pipeline_ngram.predict(valid_x)
predicted_svm1 = linear_svc_pipeline_ngram.predict(train_x)
print(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
print("Classification Report for LinearSVC using Ngram Level Tf Idf Vectorizer No Kernel\n")
...
req = svm_pipeline_ngram.fit(train_x, train_y)
predicted_svm = svm_pipeline_ngram.predict(valid_x)
print(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
print("Classification Report for SVC using Ngram Level Tf Idf Vectorizer Linear Kernel\n")
print(classification_report(valid_y, predicted_svm))
print("Train Accuracy ", metrics.accuracy_score(predicted_svm, valid_y))
print("Test Accuracy ", req.score(train_x, train_y))
print(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n")
...
req = nusvc_pipeline_ngram.fit(train_x, train_y)
predicted_svm = nusvc_pipeline_ngram.predict(valid_x)
print(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
print("Classification Report for NuSVC using Ngram Level Tf Idf Vectorizer Linear Kernel\n")
print(classification_report(valid_y, predicted_svm))
print("Train Accuracy ", metrics.accuracy_score(predicted_svm, valid_y))
print("Test Accuracy ", req.score(train_x, train_y))
print(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
